...
const [fieldOfExpertise, setFieldOfExpertise] = useState("");
  ...
  const handleApplication = async (e) => {
    ...
    if (!validateEmail(email)) {
      toast.error("Please enter a valid email address with the domain 'gmail.com'.");
      return;
    }
    ...
    try {
      toast.promise(
        axios.post("http://localhost:4000/api/v1/application/post", formData, {
  ...
  return (
    <section className="application">
      <div className="container">
        <h3 style={{color: 'cadetblue'}}>Application Form</h3>
